...
define('USP_URL', 'http://plugin-planet.com');
...
if (!class_exists('USP_Pro')) {
	class USP_Pro {
		...
		public static function more_defaults() {
			$defaults = array(
				'tax_before'          => '<div class="usp-error">' . __('Required field: ', 'usp'),
				'tax_after'           => '</div>',
				'custom_field_before' => '<div class="usp-error">' . __('Required field: ', 'usp'),
	...
	post_id     = %%post_id%%</pre></p>';
		...
		function callback_input_text($args) {
			...
			echo '<p><input name="usp_' . $type . '['. $id .']" type="text" value="' . $value . '" style="' . $width . '" />';
		...
		function callback_checkbox($args) {
			...
			echo '<p><input name="usp_'. $type .'['. $id .']" type="checkbox" value="1" '. $checked .' /> <label for="usp_'. $type .'['. $id .']">'. $label .'</label></p>';
		}
		function callback_number($args) {
			...
			echo '<p><input name="usp_'. $type .'['. $id .']" type="number" step="1" min="0" max="999" maxlength="3" value="'. $value .'" /> <label for="usp_'. $type .'['. $id .']">'. $label .'</label></p>';
		}
